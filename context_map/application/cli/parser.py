...
def create_parser() -> argparse.ArgumentParser:
    ...
    sp_panorama = sp.add_parser("panorama", help="Tablero general de actividad multi-proyecto y semáforos")
    sp_panorama.add_argument("--dias", type=int, default=14, help="Días hacia atrás para el análisis (default: 14)")
    sp_panorama.add_argument("--proyecto", default=None, help="Filtrar por nombre de proyecto")
    sp_panorama.add_argument("--solo-sesiones", action="store_true", help="Mostrar únicamente sesiones interactivas")
    sp_panorama.add_argument("--json", action="store_true", help="Salida JSON estructurada para consumo de agentes")
    sp_panorama.add_argument("--db", default=None, help="Ruta a la BD personal")

    sp_timeline = sp.add_parser("timeline", help="Línea temporal agregada de sesiones y eventos con fecha")
    sp_timeline.add_argument("--dias", type=int, default=30, help="Días hacia atrás a incluir (default: 30)")
    sp_timeline.add_argument("--proyecto", default=None, help="Filtrar por nombre de proyecto")
    sp_timeline.add_argument("--json", action="store_true", help="Salida JSON estructurada")
    sp_timeline.add_argument("--db", default=None, help="Ruta a la BD personal")

    sp_repair = sp.add_parser("repair", help="Saneamiento, desduplicación e higiene de la BD personal")
    sp_repair.add_argument("--dry-run", action="store_true", help="Simulación sin modificar datos")
    sp_repair.add_argument("--all", action="store_true", help="Ejecutar todas las acciones de saneamiento")
    sp_repair.add_argument("--merge-duplicados", action="store_true", help="Fusionar proyectos duplicados por nombre")
    sp_repair.add_argument("--fill-ruta", action="store_true", help="Autocompletar rutas de proyectos descubiertas en disco")
    sp_repair.add_argument("--drop-vacios", action="store_true", help="Eliminar proyectos sin contenido")
    sp_repair.add_argument("--purge-ruido", action="store_true", help="Eliminar eventos de ruido (TODOs falsos, .vercel, desktop.ini)")
    sp_repair.add_argument("--vacuum", action="store_true", help="Reconstruir índices FTS5 y ejecutar VACUUM")
    sp_repair.add_argument("--rutas", default="", help="Rutas adicionales para búsqueda de proyectos")
    sp_repair.add_argument("--json", action="store_true", help="Salida JSON estructurada")
    sp_repair.add_argument("--db", default=None, help="Ruta a la BD personal")
